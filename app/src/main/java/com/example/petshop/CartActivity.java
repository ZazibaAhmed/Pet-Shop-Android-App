...
import com.example.petshop.ViewHolder.CartViewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull final CartViewHolder cartViewHolder, int i,final @NonNull Cart cart) {
                ...
                DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference("Food");
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int i)
                            {
                                /*if(i==0){
                                    ...
                                    intent.putExtra("fpid",cart.getPid());
                                    intent.putExtra("spid",cart.getPid());
                                    intent.putExtra("mpid",cart.getPid());
                                    startActivity(intent);
